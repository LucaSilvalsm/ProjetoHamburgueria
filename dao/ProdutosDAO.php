...
require_once(__DIR__ . "/../models/Produtos.php");
    ...
    class ProdutosDAO implements ProdutosDAOInterface{
        ...
        public function buildProdutos($data){// para criar o objeto hamburguer $usuario->id = $data["id"];
        ...
        public function create(Produtos $produtos){ // para criar o hambúrguer
        ...
        public function update(Produtos $produtos){ // para localizar o hamburguer 
